...
void  ST7565::Asc_Char(int16_t x1, int16_t y1,unsigned char c PROGMEM,byte he_so_phong_to,  bool color) {
...
void ST7565::Asc_String(int16_t x1, int16_t y1,PGM_CHAR s ,byte he_so_phong_to, bool color) {
...
x-=font_w;// dịch con trỏ sang trái  sau mỗi lần ghi
  ...
  void ST7565::Number_Long(int16_t x,int16_t y, long a,byte select_font, byte he_so_phong_to, bool color){
if(  he_so_phong_to==1){
...
void ST7565::Number_Ulong(int16_t x, int16_t y,unsigned long a,byte select_font,byte he_so_phong_to, bool color){
if(  he_so_phong_to==1){
...
void  ST7565::Uni_Char(int16_t x1, int16_t y1, char16_t c, byte he_so_phong_to, bool color){ 
...
void ST7565::Uni_String(int16_t x1, int16_t y1,PGM_CHAR16T s , byte he_so_phong_to ,bool color) {
if(he_so_phong_to==1){
...
void ST7565::clear_display(void) {
  ...
  void ST7565::phong_to(int16_t x0, int16_t y0, uint16_t w0, uint16_t h0, uint8_t he_so_phong_to, bool color){
